...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("balance", sa.Numeric(18, 6), nullable=False, server_default="0.000000"),
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum("CREDIT", "DEBIT", "TRANSFER_IN", "TRANSFER_OUT", "CONVERSION", name="transactiontype"), nullable=False, index=True),
